<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompressionPressureGuage.ascx.cs" Inherits="controls_CompressionPressureGuage" %>
...
<h3>Performance Analysis of Compressor Pressure Guage</h3>
