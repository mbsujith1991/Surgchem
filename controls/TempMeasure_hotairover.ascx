<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TempMeasure_hotairover.ascx.cs" Inherits="controls_TempMeasure_hotairover" %>
...
<asp:HiddenField ID="tempmeasure_hotairoven" runat="server" />
<h3>Temperature Measurement of Hot Air Oven</h3>
    <table border="1" style="width:100%;">
       ...
       <tr>
        ...
        <td>
            <asp:TextBox ID="txtsetdut1" runat="server" CssClass="textbox" Text="160"></asp:TextBox>
        </td>
