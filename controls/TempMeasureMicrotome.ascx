<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TempMeasureMicrotome.ascx.cs" Inherits="controls_TempMeasureMicrotome" %>
...
<h3>Temperature Measurement Microtome</h3>
    <table border="1" style="width:100%;">
        <tr>
            ...
            <th colspan="3">Temperature measured on STD specific Test Points(TPs)</th>
       ...
       <tr>
        ...
        <td>
            <asp:TextBox ID="txtsetdut1" runat="server" CssClass="textbox" Text="-22"></asp:TextBox>
        </td>
             <td><asp:TextBox ID="txtdispdut1" runat="server" CssClass="textbox" Text="-21.2"></asp:TextBox></td>
        <td><asp:TextBox ID="txttp1_1" runat="server" CssClass="textbox" Text="21.8"></asp:TextBox></td>
        <td><asp:TextBox ID="txttp2_1" runat="server" CssClass="textbox" Text="21.9"></asp:TextBox></td>
        <td><asp:TextBox ID="txttp3_1" runat="server" CssClass="textbox" Text="22.0"></asp:TextBox></td>
