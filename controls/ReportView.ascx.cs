...
public partial class controls_ReportView : System.Web.UI.UserControl
{
        ...
        if (Request.IsAuthenticated && Session["Usertype"] != null)
        {
            ...
            else
            {
                ...
                if (usertype == "2")
                {
                    ...
                    HtmlGenericControl listreport = (HtmlGenericControl)this.Page.Master.FindControl("lireport");
                    listreport.Style.Add("background-color", "#195A7F");
                    HtmlGenericControl maindiv = (HtmlGenericControl)Page.Master.FindControl("mainmenu");
                    maindiv.Visible = false;
                    HtmlGenericControl adminconsole = (HtmlGenericControl)this.Page.Master.FindControl("adminconsole");
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        if (reportno_hidden.Value != "")
                        {
                            ShowPerftable();
                            btnprint.Visible = true;
                            pnlprint.Visible = true;
                            PopulateHospitalId();
                            retreiveReportID(reportno_hidden.Value);
                            Bind_ReportInfo();
                            CustomerInfo();
                            //populate_perfname();
                            //bindperfid();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Enter ReportNo ! ');", true);
        }
        else
        {
            ShowPerftable();
            ...
            pnlprint.Visible = true;
            PopulateHospitalId();
            retreiveReportID(txtSearchString.Text.Trim().Replace("'", "''"));
            Bind_ReportInfo();
            CustomerInfo();
            //populate_perfname();
            //bindperfid();
    ...
    protected void pdf_Click(object sender, EventArgs e)
    {
        ...
        ////using (var stringWrite = new StreamWriter(System.Web.HttpContext.Current.Server.MapPath("~/DB_Backup/surgchem.doc")))
        ////{
        //System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
        //// Create a form to contain the grid
        //HtmlForm frm = new HtmlForm();
        //pnlprint.Parent.Controls.Add(frm);
        //frm.Attributes["runat"] = "server";
        //frm.Controls.Add(pnlprint);
        ...
        //        HtmlForm htfrm = new HtmlForm();
        //        pnlprint.Parent.Controls.Add(htfrm);
        //        //htfrm.Attributes["runat"] = "server";
        //        htfrm.Controls.Add(pnlprint);
        //        htfrm.RenderControl(hw);
