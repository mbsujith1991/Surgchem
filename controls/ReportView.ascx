<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportView.ascx.cs" Inherits="controls_ReportView" %>
...
<div class="content_wrap" runat="server">
    <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
        ...
        <table>
            <tr>
                <td><asp:Label ID="lblsearchby" runat="server" Text="Search by: " ForeColor="Black"/></td>
                <td></td>
                <td> <asp:TextBox ID="txtSearchString" runat="server" Width="200px" BorderColor="Black" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
           
                    <asp:TextBoxWatermarkExtender ID="txtSearchString_TextBoxWatermarkExtender" WatermarkText="Barcode ID" WatermarkCssClass="watermarked" runat="server" Enabled="True" TargetControlID="txtSearchString">
                ...
                <td>
                    ...
                    &nbsp;
                    <asp:Button ID="btnprint" runat="server" Text="Print" CssClass="button-link" Visible="false" 
                        OnClientClick = "return PrintPanel();"></asp:Button>
                   &nbsp;
                    <%--<asp:Button ID="pdf" runat="server" Text="Generate Pdf" CssClass="button-link" OnClick="pdf_Click"/>--%>
                </td> 
            </tr>
...
<asp:Panel ID="pnlprint" runat="server" CssClass="Section1">
