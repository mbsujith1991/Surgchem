<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Temperaturemeasure_Constant.ascx.cs" Inherits="controls_Temperaturemeasure_Constant" %>
...
<h3>Temperature Measurement(Constant Temperature Device)</h3>
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txttempset1" runat="server" CssClass="textbox" Text="36 &deg;C"></asp:TextBox></td>
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txttempset2" runat="server" CssClass="textbox" Text="40 &deg;C"></asp:TextBox></td>
