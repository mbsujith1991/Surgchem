<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Temp_hygrometer.ascx.cs" Inherits="controls_Temp_hygrometer" %>
...
<h3>Temperature of Hygrometer</h3>
...
<table style="width:100%;" border="1">
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txtstd1" runat="server" Text="35ºC" CssClass="textbox"></asp:TextBox></td>
        <td><asp:TextBox ID="txtdut1" runat="server" Text="35.3ºC" CssClass="textbox"></asp:TextBox></td>
        <td><asp:TextBox ID="txtdev1" runat="server" Text="0.3" CssClass="textbox"></asp:TextBox></td>
