<%@ Control Language="C#" AutoEventWireup="true" CodeFile="flowrate_heparin.ascx.cs" Inherits="controls_flowrate_heparin" %>
...
<h3>Flow Rate of Heparin Pump</h3>
    <table  border="1" style="width:100%;">
        <tr>
            <td>Sl No</td>
            <td>Value set on DUT</td>
            <td colspan="3">Instant Values Measured on Standard in ml/hrs</td>
            <td>Mean Value</td>
            <td>Deviation(±5%)</td>
            <td>Remarks</td>
        </tr>
        <tr>
            ...
            <td><asp:TextBox ID="txtstd1" runat="server" CssClass="textbox" Text="8 ml"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtstd2" runat="server" CssClass="textbox" Text="10 ml"></asp:TextBox></td>
