...
public partial class controls_TempMeasure_fluidwarmer : System.Web.UI.UserControl
{
    ...
    {
        edit_Reportid = Session["Editreportid18"];
    }
    ...
    {
        db1.strCommand = "insert into check_perftest(PerfID,Perf_TestName) values('" + Session["Perfid18"].ToString() + "','" + Session["performancename18"].ToString() + "')";
        db1.insertqry();
        perfname = Session["performancename18"].ToString();
