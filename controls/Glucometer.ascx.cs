...
public partial class controls_Glucometer : System.Web.UI.UserControl
{
    ...
    {
        edit_Reportid = Session["Editreportid47"];
    }

    public void save_performancetest()
    {
        db1.strCommand = "insert into check_perftest(PerfID,Perf_TestName) values('" + Session["Perfid47"].ToString() + "','" + Session["performancename47"].ToString() + "')";
        db1.insertqry();
        perfname = Session["performancename47"].ToString();
