<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TempMeasure_Incubator.ascx.cs" Inherits="controls_TempMeasure_Incubator" %>
...
<asp:HiddenField ID="tempmeasure_incubator" runat="server" />
<h3>Temperature Measurement of Incubator</h3>
    <table border="1" style="width:100%;">
       ...
       <tr>
        ...
        <td>
            <asp:TextBox ID="txtsetdut1" runat="server" CssClass="textbox" Text="60"></asp:TextBox>
        </td>
