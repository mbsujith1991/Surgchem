<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Temperatureguage.ascx.cs" Inherits="controls_Temperatureguage" %>
...
<h3>Performance Analysis of Temperature Guage</h3>
...
<table style="width:100%;" border="1">
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txtval2" runat="server" CssClass="textbox" Text=""></asp:TextBox></td>
