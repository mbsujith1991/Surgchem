<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JacketPressureGuage.ascx.cs" Inherits="controls_JacketPressureGuage" %>
...
<h3>Performance Analysis of Jacket Pressure Guage</h3>
