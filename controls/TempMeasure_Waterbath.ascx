<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TempMeasure_Waterbath.ascx.cs" Inherits="controls_TempMeasure_Waterbath" %>
...
<h3>Temperature Measurement of Water Bath</h3>
...
<table style="width:100%;" border="1">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtdut1" runat="server" CssClass="textbox" Text="36"></asp:TextBox>
        </td>
        ...
        <td><asp:TextBox ID="txtspec1" runat="server" CssClass="textbox" Text="±1 ºC"></asp:TextBox></td>
     ...
     <tr>
        ...
        <td>
            <asp:TextBox ID="txtdut2" runat="server" CssClass="textbox" Text="60"></asp:TextBox>
        </td>
        ...
        <td><asp:TextBox ID="txtspec2" runat="server" CssClass="textbox" Text="±1 ºC"></asp:TextBox></td>
     ...
     <tr>
        ...
        <td>
            <asp:TextBox ID="txtdut3" runat="server" CssClass="textbox" Text="100"></asp:TextBox>
        </td>
        ...
        <td><asp:TextBox ID="txtspec3" runat="server" CssClass="textbox" Text="±1 ºC"></asp:TextBox></td>
