<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TemperatureTestForAutoclave.ascx.cs" Inherits="TemperatureTestForAutoclave" %>
...
<asp:HiddenField ID="temp_autoclave_hidden" runat="server" />
<h3>Temperature Test For Autoclave</h3>
...
<table style="width:100%;" border="1">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txttempdut1" runat="server" Text="121.2" CssClass="textbox"></asp:TextBox>
        </td>
        <td>
    ...
    <tr>
        <td>
            <asp:TextBox ID="txtsl2" runat="server" Text="" CssClass="textbox"></asp:TextBox>
        </td>
        <td>
            <asp:TextBox ID="txttempdut2" runat="server" Text="" CssClass="textbox"></asp:TextBox>
        </td>
        <td>
            <asp:TextBox ID="txttp1_2" runat="server" Text="" CssClass="textbox"></asp:TextBox></td>
        <td>
        ...
        <td>
            <asp:TextBox ID="txtrem2" runat="server" Text="" CssClass="textbox"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
            <asp:TextBox ID="txtsl3" runat="server" Text="" CssClass="textbox"></asp:TextBox>
        </td>
        <td>
        ...
        <td>
            <asp:TextBox ID="txtrem3" runat="server" Text="" CssClass="textbox"></asp:TextBox>
        </td>
    </tr>
</table>
<br />
