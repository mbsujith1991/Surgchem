...
public partial class Perf_Control_Views_View_flowrate_dialysis : System.Web.UI.UserControl
{
            ...
            for (int j = 0; j < dt_value.Rows.Count; j++)
            {
                if (j == 0)
                {
                    ...
                    if (flowarray1.Count() > 0)
                    {
                        ...
                        if (flowarray1[6].ToString() != "")
                            lblflow7.Text = flowarray1[6].ToString();
                        if (flowarray1[7].ToString() != "")
                            lblflow8.Text = flowarray1[7].ToString();
                ...
                if (j == 1)
                {
                    ...
                    if (flowarray2.Count() > 0)
                    {
                        if (flowarray2[0].ToString() != "")
                            lblflow9.Text = flowarray2[0].ToString();
                        if (flowarray2[1].ToString() != "")
                            lblflow10.Text = flowarray2[1].ToString();
                        if (flowarray2[2].ToString() != "")
                            lblflow11.Text = flowarray2[2].ToString();
                        if (flowarray2[3].ToString() != "")
                            lblflow12.Text = flowarray2[3].ToString();
                        if (flowarray2[4].ToString() != "")
                            lblflow13.Text = flowarray2[4].ToString();
                        if (flowarray2[5].ToString() != "")
                            lblflow14.Text = flowarray2[5].ToString();
                        if (flowarray2[6].ToString() != "")
                            lblflow15.Text = flowarray2[6].ToString();
                        if (flowarray2[7].ToString() != "")
                            lblflow16.Text = flowarray2[7].ToString();
                ...
                if (j == 1)
                {
                    ...
                    string perfvalue2 = sb_flow3.ToString();
                    flowarray3 = perfvalue2.Split(',');
                    if (flowarray3.Count() > 0)
                    {
                        if (flowarray3[0].ToString() != "")
                            lblflow17.Text = flowarray3[0].ToString();
                        if (flowarray3[1].ToString() != "")
                            lblflow18.Text = flowarray3[1].ToString();
                        if (flowarray3[2].ToString() != "")
                            lblflow19.Text = flowarray3[2].ToString();
                        if (flowarray3[3].ToString() != "")
                            lblflow20.Text = flowarray3[3].ToString();
                        if (flowarray3[4].ToString() != "")
                            lblflow21.Text = flowarray3[4].ToString();
                        if (flowarray3[5].ToString() != "")
                            lblflow22.Text = flowarray3[5].ToString();
                        if (flowarray3[6].ToString() != "")
                            lblflow23.Text = flowarray3[6].ToString();
                        if (flowarray3[7].ToString() != "")
                            lblflow24.Text = flowarray3[7].ToString();
    ...
    public void Hide_perftable()
    {
        if (flowid == 0)
            ...
            lblflow.Text = "Flow Rate of Dialysis Machine";
        if (flowtr1 == 0)
        {
