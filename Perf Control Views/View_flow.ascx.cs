...
public partial class Perf_Control_Views_View_flow : System.Web.UI.UserControl
{
                ...
                if (j == 2)
                {
                    ...
                    if (flowarray3.Count() > 0)
                    {
                        ...
                        if (flowarray3[3].ToString() != "")
                            lblflow16.Text = flowarray3[3].ToString();
                        if (flowarray3[4].ToString() != "")
                            lblflow17.Text = flowarray3[4].ToString();
                        if (flowarray3[5].ToString() != "")
                            lblflow18.Text = flowarray3[5].ToString();
