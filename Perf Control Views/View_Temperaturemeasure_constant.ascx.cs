...
public partial class Perf_Control_Views_View_Temperaturemeasure_constant : System.Web.UI.UserControl
{
    ...
    public void Hide_perftable()
    {
        if (deepfreeid == 0)
            ...
            lbldeepfreezer.Text = "Temperature Measurement (Constant Temp Device)";
        if (deepfreezertr1 == 0)
