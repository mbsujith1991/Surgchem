...
public partial class Perf_Control_Views_View_TempDeepfreezer : System.Web.UI.UserControl
{
                ...
                if (j == 0)
                {
                    ...
                    if (deepfreezerarray1.Count() > 0)
                    {
                        ...
                        if (deepfreezerarray1[6].ToString() != "")
                            lbldeep7.Text = deepfreezerarray1[6].ToString();
                        if (deepfreezerarray1[7].ToString() != "")
                            lbldeep8.Text = deepfreezerarray1[7].ToString();
                        if (deepfreezerarray1[8].ToString() != "")
                            lbldeep9.Text = deepfreezerarray1[8].ToString();
                        if (deepfreezerarray1[9].ToString() != "")
                            lbldeep10.Text = deepfreezerarray1[9].ToString();
                        if (deepfreezerarray1[10].ToString() != "")
                            lbldeep11.Text = deepfreezerarray1[10].ToString();
                        if (deepfreezerarray1[11].ToString() != "")
                            lbldeep12.Text = deepfreezerarray1[11].ToString();
                    }
                }
            }
        }
    ...
    public void Hide_perftable()
    {
        if (deepfreeid == 0)
            ...
            lbldeepfreezer.Text = "Temperature Measurement Deep Freezer";
        if (deepfreezertr1 == 0)
