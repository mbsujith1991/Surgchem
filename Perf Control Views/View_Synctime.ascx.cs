...
public partial class Perf_Control_Views_View_Synctime : System.Web.UI.UserControl
{
  ...
  int synctimeid = 0, syntr1 = 0, syntr2 = 0, syntr3 = 0;
    ...
    public void Bind_Synctime(string sReportid,string sPerfid)
    {
    ...
    {
        if (synctimeid == 0)
            syntimediv.Visible = false;
        else
            lblsynctime.Text = "Sync Time";
        if (syntr1 == 0)
