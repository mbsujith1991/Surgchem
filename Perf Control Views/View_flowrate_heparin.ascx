<%@ Control Language="C#" AutoEventWireup="true" CodeFile="View_flowrate_heparin.ascx.cs" Inherits="Perf_Control_Views_View_flowrate_heparin" %>
       ...
       <div class="align_middle" style="font-weight:bold;width:6.27in;">
           <table  border="1" cellspacing="0" cellpadding="0" style="height:30px;text-align:center;font-size:8pt;width:100%;">
             <tr>
                ...
                <th colspan="3">Instant Values Measured on Standard in ml/hrs</th>
                <th>Mean Value</th>
                <th>Deviation(±5%)</th>
                <th>Remarks</th>
             </tr>
