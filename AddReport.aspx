        ...
        <asp:View ID="addreport" runat="server">
            <div class="content_box align_left shadow round_corner5 colwidth975">
                ...
                <table cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblReportNo" runat="server" Text="BMT/"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblBarcode" runat="server" Text="BMT/"></asp:Label>
            ...
            <div class="content_box align_left shadow round_corner5 colwidth45">
                <table cellpadding="5" cellspacing="5" style="height: 650px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlproductname" runat="server" CssClass="hosp_class"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlmanuf" runat="server" CssClass="hosp_class"
                                OnSelectedIndexChanged="ddlmanuf_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlmodel" runat="server" CssClass="hosp_class" ClientIDMode="Static"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlevicetype" runat="server" CssClass="hosp_class" ClientIDMode="Static"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddldeviceclass" runat="server" CssClass="hosp_class" ClientIDMode="Static"></asp:DropDownList>
                    ...
                    <tr>
                        <td>Supply</td>
                        <td>
                            <asp:TextBox ID="txtsupply" runat="server" CssClass="hosp_class" ClientIDMode="Static"></asp:TextBox>
                    ...
                    <tr>
                        <td>Test Done</td>
                        <td>
                            <asp:CheckBox ID="ch_elect" runat="server" Text="Electrical Safety"
            ...
            <div class="content_box align_ight shadow round_corner5 colwidth45">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:ListBox ID="lsttrace" SelectionMode="Multiple" runat="server" Rows="5" Width="250px" Font-Bold="true"></asp:ListBox>
                            <br />
        ...
        <asp:View ID="editreport" runat="server">
            ...
            <div id="Div1" class="content_wrap" runat="server">
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblsearchvalue" runat="server" Text="Values : " ForeColor="White" /></td>
                        ...
                        <td>
                            ...
                            <cc1:TextBoxWatermarkExtender ID="txtsearchcompany_TextBoxWatermarkExtender" runat="server" WatermarkText="Enter Hospital Name" Enabled="True" TargetControlID="txtsearchcompany"></cc1:TextBoxWatermarkExtender>
                            <cc1:TextBoxWatermarkExtender ID="txtSearchString1_TextBoxWatermarkExtender" WatermarkText="Enter Report No" runat="server" Enabled="True" TargetControlID="txtSearchString1"></cc1:TextBoxWatermarkExtender>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="Report_info_ID" PageSize="50">
